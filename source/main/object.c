...
static void draw_cloaked_object(object *obj,fix light,fix *glow,fix cloak_start_time,fix cloak_end_time, ushort *alt_tmap)
{
...
void reset_player_object()
{
	...
	// sometimes the secondary fire button has been pressed to clear the death screen
	Next_missile_fire_time = GameTime + F1_0;
