...
int create_path_points(object *objp, int start_seg, int end_seg, point_seg *psegs, short *num_points, int max_depth, int random_flag, int safety_flag, int avoid_seg)
{
	...
	memset(seg_queue, 0, sizeof(seg_queue));
...
int path_index_compare(const void *_i1, const void *_i2)
{
	const obj_path *i1 = (const obj_path*)_i1;
	const obj_path *i2 = (const obj_path*)_i2;
