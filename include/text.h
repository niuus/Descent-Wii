...
extern const char* TXT_CONTROL_WIIMOTE[];
...
#define TNUM_CYCLE_PRIM         N_TEXT_STRINGS
#define TNUM_CYCLE_SEC          (N_TEXT_STRINGS+1)
...
#define CONTROL_TEXT(control_type) ((char*)TXT_CONTROL_WIIMOTE[control_type])
